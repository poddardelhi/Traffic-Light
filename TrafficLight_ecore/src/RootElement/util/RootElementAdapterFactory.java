...
public class RootElementAdapterFactory extends AdapterFactoryImpl {
	...
	protected RootElementSwitch<Adapter> modelSwitch =
		new RootElementSwitch<Adapter>() {
			...
			@Override
			public Adapter casePedestrianLight(PedestrianLight object) {
				return createPedestrianLightAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link RootElement.Timer <em>Timer</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link RootElement.Controller <em>Controller</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link RootElement.PedestrianLight <em>Pedestrian Light</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createPedestrianLightAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link RootElement.CarLight <em>Car Light</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
