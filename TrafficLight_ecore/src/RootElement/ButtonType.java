 ...
 * <!-- end-user-doc -->
 * @see RootElement.RootElementPackage#getButtonType()
 * @model
 * @generated
 */
public enum ButtonType implements Enumerator {
	 ...
	 * @ordered
	 */
	public static final int BUTTON_A_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int BUTTON_B_VALUE = 1;
	...
	public static ButtonType get(int value) {
		switch (value) {
			...
			case BUTTON_B_VALUE: return BUTTON_B;
		}
		return null;
	}
